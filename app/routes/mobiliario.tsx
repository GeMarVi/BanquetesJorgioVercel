...
const mobiliario = () => {
    return (
        <main className="max-w-6xl px-3 md:px-0 text-center mx-auto bg-azulOscuro text-white">
            <div className="md:flex">
                <ul className="text-left md:pr-16 pb-8 lg:py-8 flex flex-col md:w-1/2 md:justify-center">
                ...
                <img className="flex-1 md:w-1/2 mb-8 md:mb-0" src={carpas} alt="Imagen de las Espadas brasileñas" />
            </div>
            <div className="md:flex flex-row-reverse">
                <ul className="text-left md:pl-16 py-8 flex flex-col gap-2 md:w-1/2 md:justify-center">
                ...
                <img className="flex-1 md:w-1/2 mb-8 md:mb-0" src={mesas} alt="Imagen de las Espadas brasileñas" />
            </div>
            <div className="md:flex">
                <ul className="text-left md:pr-16 py-8 flex flex-col gap-2 md:w-1/2 md:justify-center">
                ...
                <img className="flex-1 md:w-1/2 mb-8 md:mb-0" src={salas} alt="Imagen de las Espadas brasileñas" />
            </div>
            <div className="md:flex flex-row-reverse">
                <ul className="text-left md:pl-16 py-8 flex flex-col md:justify-center md:w-1/2 gap-2">
                ...
                <img className="flex-1 md:w-1/2 mb-8 md:mb-0" src={periqueras} alt="Imagen de las Espadas brasileñas" />
            </div>
            <div className="md:flex">
                <ul className="text-left md:pr-16 py-8 flex flex-col gap-2 md:w-1/2 md:justify-center">
