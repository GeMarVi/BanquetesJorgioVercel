...
const SobreNosotros = () => {
    return (
        <section className="max-w-6xl mx-auto mt-32 lg:mt-40">
            <h3 className="text-heading-1 text-center text-5xl lg:text-7xl font-clash mb-8 lg:mb-0">Acerca <span className="text-gradient">de nosotros</span></h3>
            <div className="flex lg:w-auto lg:items-center flex-col-reverse lg:flex-row lg:h-min lg:gap-8 bg-transparent lg:pt-20">
                ...
                <div className="lg:w-1/2 h-max flex flex-col justify-between mx-4 lg:mx-0 pb-12 lg:px-4">
                    <h4 className="text-4xl lg:text-5xl text-left font-variable font-[600] text-heading lg:text-nowrap mb-6 relative">Bienvenido a Jorgio</h4>
                    ...
                    <p className="text-heading text-left text-lg lg:text-xl antialiased font-monse mb-6">
                        Especializados en el servicio de <strong className="text-gradient-6">Espadas Brasileñas</strong> y <strong className="text-gradient-6"> Parrilladas</strong> brindadando un servicio de alta calidad en todo momento
                    </p>
                    ...
                    <div className="flex justify-between items-center text-heading">
                        <div className="flex justify-between gap-2 lg:gap-4 font-title items-center px-2 lg:px-4 border-l-2 lg:border-l-4 border-custom-border">
                            <p className="text-3xl lg:text-5xl font-extrabold text-gradient font-Inter">20</p>
                            <p>Años de <span className="block text-heading font-bold text-sm lg:text-base uppercase">Experiencia</span></p>
                        </div>
                        <div className="flex justify-between gap-2 lg:gap-4 font-title items-center px-2 lg:px-4 border-l-2 lg:border-l-4 border-custom-border">
                            <p className="text-3xl lg:text-5xl font-extrabold text-gradient font-Inter">300+</p>
