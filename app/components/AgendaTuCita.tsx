...
const AgendaTuCita = (data: ActionData) => {
   ...
   return (
      <section
         className="pt-32 lg:pt-40 max-w-6xl mx-auto mb-40 overflow-hidden lg:overflow-visible"
      >
         <HeadingVistas
            ...
            whileInView="scale(1)"
         />
         <div className="flex flex-col lg:flex-row justify-between lg:items-stretch mx-auto lg:h-auto mt-32">
            <FormularioContacto
               nombre={data.nombre}
            ...
            <div
               ...
               className="flex h-[40rem] lg:h-auto p-4 lg:p-8 lg:flex-1 flex-col justify-center items-center gap-20 bg-cover bg-bottom bg-no-repeat relative"
            >
